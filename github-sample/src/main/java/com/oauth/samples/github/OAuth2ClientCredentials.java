...
package com.oauth.samples.github;
...
public class OAuth2ClientCredentials {
  ...
  public static final String API_KEY = "f45a81b58f3949c96ffd";

  /** Value of the "API Secret". */
  public static final String API_SECRET = "203a2cd930f161871b26265a40f48f84810eac8d";
